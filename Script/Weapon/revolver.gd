...
@onready var hammer_player = $Gun/Animation/Mesh/Hammer/HammerSound
@onready var trigger_player = $Gun/Animation/Mesh/Trigger/ClickSoundPlayer
@onready var cylinder = $Gun/Animation/Mesh/Cylinder
...
func rotate_cylinder():
	var cylinder_rotation = cylinder.global_rotation
	cylinder_rotation += 60
	cylinder.rotation.x = lerp_angle(cylinder.rotation.x, cylinder_rotation, 500 * get_physics_process_delta_time())
